// Sigue sin funcionar
// === DEBUG HORARIOS ESPECIALISTA ===
// solicitar-turno.component.ts:431 Especialista seleccionado: {id: 30, nombre: 'Lautaro', apellido: 'Solis', edad: 20, dni: '45123123', …}
// solicitar-turno.component.ts:437 Todos los horarios del especialista: (5) [{…}, {…}, {…}, {…}, {…}]
// solicitar-turno.component.ts:443 Horarios para la especialidad seleccionada: [{…}]0: dia: "Viernes"especialidad: "Oftalmología"hora_final: "12:00:00"hora_inicio: "08:00:00"id: 53usuario_id: 30[[Prototype]]: Objectlength: 1[[Prototype]]: Array(0)
// database.service.ts:394 Buscando días disponibles para: {especialistaId: 30, especialidad: 'Oftalmología'}
// database.service.ts:543 Horarios obtenidos de la BD: [{…}]
// database.service.ts:559 Días únicos encontrados: ['Viernes']
// database.service.ts:565 Generando fechas para los próximos 15 días...
// database.service.ts:573 Día 1: 22/06 es Domingo
// database.service.ts:596 Domingo NO está en los días disponibles
// database.service.ts:573 Día 2: 23/06 es Lunes
// database.service.ts:596 Lunes NO está en los días disponibles
// database.service.ts:573 Día 3: 24/06 es Martes
// database.service.ts:596 Martes NO está en los días disponibles
// database.service.ts:573 Día 4: 25/06 es Miércoles
// database.service.ts:596 Miércoles NO está en los días disponibles
// database.service.ts:573 Día 5: 26/06 es Jueves
// database.service.ts:596 Jueves NO está en los días disponibles
// database.service.ts:573 Día 6: 27/06 es Viernes
// database.service.ts:577 Viernes está en los días disponibles, verificando disponibilidad...
// database.service.ts:438 Verificando fecha 2025-06-27 (Jueves) para especialidad Oftalmología
// database.service.ts:448 Horarios encontrados para Jueves: []
// database.service.ts:451 No hay horarios para Jueves en Oftalmología
// database.service.ts:593 ❌ Fecha sin espacio: 27/06
// database.service.ts:573 Día 7: 28/06 es Sábado
// database.service.ts:596 Sábado NO está en los días disponibles
// database.service.ts:573 Día 8: 29/06 es Domingo
// database.service.ts:596 Domingo NO está en los días disponibles
// database.service.ts:573 Día 9: 30/06 es Lunes
// database.service.ts:596 Lunes NO está en los días disponibles
// database.service.ts:573 Día 10: 01/07 es Martes
// database.service.ts:596 Martes NO está en los días disponibles
// database.service.ts:573 Día 11: 02/07 es Miércoles
// database.service.ts:596 Miércoles NO está en los días disponibles
// database.service.ts:573 Día 12: 03/07 es Jueves
// database.service.ts:596 Jueves NO está en los días disponibles
// database.service.ts:573 Día 13: 04/07 es Viernes
// database.service.ts:577 Viernes está en los días disponibles, verificando disponibilidad...
// database.service.ts:438 Verificando fecha 2025-07-04 (Jueves) para especialidad Oftalmología
// database.service.ts:448 Horarios encontrados para Jueves: []
// database.service.ts:451 No hay horarios para Jueves en Oftalmología
// database.service.ts:593 ❌ Fecha sin espacio: 04/07
// database.service.ts:573 Día 14: 05/07 es Sábado
// database.service.ts:596 Sábado NO está en los días disponibles
// database.service.ts:573 Día 15: 06/07 es Domingo
// database.service.ts:596 Domingo NO está en los días disponibles
// database.service.ts:600 Fechas finales disponibles: []
// solicitar-turno.component.ts:160 Fechas disponibles obtenidas: []
